...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex)
{
    ...
    // grantcoin: moved from original location in peercoin code
...
bool CBlock::AcceptBlock()
{
    ...
    // grantcoin: check for proof-of-stake blocks before allowed
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot == uint256("0x20e0e4a83365d96a79a4df5355956c3b88c33b04d408ce3ec5d4cf52a76d0bdd"));
        block.print();
...
CBlock* CreateNewBlock(CReserveKey& reservekey, CWallet* pwallet, bool fProofOfStake)
{
    ...
    // grantcoin: allow only proof-of-work blocks until proof-of-stake starting block
